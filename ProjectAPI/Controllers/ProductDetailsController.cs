...
namespace ProjectAPI.Controllers
{
    ...
    public class ProductDetailsController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult SaveInShoppingCart([FromBody] ShoppingCartDTO shoppingCartDTO)
        {
            ...
            var cartObj = _unitOfWork.Repository<ShoppingCart>()
                .GetEntityWithSpec(new BaseSpecification<ShoppingCart>(u => u.UserId == userId && u.ProductId == shoppingCartDTO.ProductId));
            ...
            int count = _unitOfWork.Repository<ShoppingCart>()
                .GetAllWithSpec(new BaseSpecification<ShoppingCart>(x => x.UserId == userId)).Count();
