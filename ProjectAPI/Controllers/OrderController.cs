...
namespace ProjectAPI.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public IActionResult PastOrders()
        {
            ...
            //var pastOrdersDTO = pastOrders.Select(o => o.ToOrderDTO()).ToList();
            return Ok(/*pastOrders.Select(o => o.ToOrderDTO()).ToList()*/pastOrders);
        }
        ...
        public  IActionResult CurrentOrder()
        {
            ...
            return Ok(currentOrder/*.ToOrderDTO()*/);
        }
    }
}
